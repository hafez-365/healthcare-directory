...
import { MapPin, Phone, Clock, User, CheckCircle, ArrowRight, Building2 } from 'lucide-react';
    ...
    <Layout>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center p-4 bg-gray-50 rounded-lg">
              ...
              <div>
                <p className="text-sm text-gray-600 font-medium">المدينة</p>
                <p className="text-gray-900 font-semibold" data-testid="text-city">
                  {hospital.city}
                </p>
              </div>
            </div>
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900 mb-4">معلومات المستشفى</h2>
            <p 
              className="text-gray-700 leading-relaxed mb-6"
              data-testid="text-hospital-info"
            >
              مستشفى {hospital.name} يقدم خدمات طبية متميزة في {hospital.city} بسعة {hospital.beds} سرير.
            </p>
      ...
      <div className="bg-white rounded-xl shadow-lg p-6 md:p-8 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <h3 className="font-bold text-gray-900 mb-4 text-lg">الموقع والوصول</h3>
            <ul className="list-disc list-inside text-gray-700 space-y-2">
              <li>العنوان: {hospital.address}</li>
              <li>المدينة: {hospital.city}</li>
              <li>رقم الهاتف: {hospital.phone}</li>
              <li>عدد الأسرة المتوفرة: {hospital.beds}</li>
            </ul>
          </div>
          
          <div>
            <h3 className="font-bold text-gray-900 mb-4 text-lg">معلومات الزيارة</h3>
            <ul className="list-disc list-inside text-gray-700 space-y-2">
              <li>احضار بطاقة الهوية</li>
              <li>الوصول قبل الموعد بـ 15 دقيقة</li>
              <li>اتباع تعليمات الأمان والسلامة</li>
              <li>احترام آداب المستشفى</li>
            </ul>
          </div>
        </div>
      </div>
